    ...
    <div className="animate-in fade-in slide-in-from-top-4 duration-500">
      ...
      >
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {/* PRIMARY INFO */}
          <div className="md:col-span-3 border-b border-sage-border pb-2">
            <h3 className="font-bold text-sage-secondary flex items-center gap-2">
              👤 {isEdit ? "তথ্য সংশোধন" : "প্রাথমিক তথ্য"} ({isEdit ? "Edit" : "Primary"} Info)
            </h3>
          </div>
          <div className="grid gap-2">
            <label className="text-xs font-bold text-sage-secondary">ইংরেজিতে নাম (Name in English) *</label>
            <input name="nameEnglish" required defaultValue={defaultNameEnglish} placeholder="Parvej Khan" className="h-11 rounded-lg border border-sage-border px-3 focus:ring-1 focus:ring-sage-primary outline-none" />
          </div>
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <input name="whatsapp" required defaultValue={defaultWhatsapp} placeholder="01XXXXXXXXX" className="h-11 rounded-lg border border-sage-border px-3 focus:ring-1 focus:ring-sage-primary outline-none" />
          </div>
          <div className="grid gap-2">
          ...
          {/* ACADEMIC INFO */}
          <div className="md:col-span-3 border-b border-sage-border pb-2 mt-4">
            <h3 className="font-bold text-sage-secondary flex items-center gap-2">
          ...
          <div className="grid gap-2">
            ...
            <input name="admissionYear" required defaultValue={defaultAdmissionYear} className="h-11 rounded-lg border border-sage-border px-3 focus:ring-1 focus:ring-sage-primary outline-none" />
          </div>
          <div className="grid gap-2">
          ...
          <div className="md:col-span-3 mt-4 space-y-4 rounded-xl border border-dashed border-sage-border bg-sage-red-50/20 p-4">
            <div className="grid gap-2">
              <label className="text-xs font-bold text-sage-secondary">ব্যাচ নির্বাচন (Select Batch) *</label>
              <select 
                name="batch" 
                required
            ...
            {selectedBatch && (
              <div className="animate-in space-y-4 fade-in zoom-in duration-300">
          ...
          <div className="md:col-span-3 border-b border-sage-border pb-2 mt-4">
            <h3 className="font-bold text-sage-secondary">অন্যান্য ও ছবি</h3>
          </div>
          ...
          <div className="md:col-span-3">
            <label className="mb-2 block text-xs font-bold text-sage-secondary text-center uppercase tracking-widest">ছাত্র-ছাত্রীর ছবি (ঐচ্ছিক)</label>
          ...
          <div className="md:col-span-3 flex justify-center pt-4">
            <button 
              ...
              className="h-14 w-full md:w-auto md:min-w-[300px] rounded-xl bg-sage-primary px-8 font-bold text-white shadow-lg shadow-sage-primary/20 transition hover:bg-sage-secondary active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isPending 
                ? "প্রসেসিং হচ্ছে..." 
                : (isEdit ? "তথ্য সংরক্ষণ করুন" : "শিক্ষার্থী ভর্তি সম্পন্ন করুন")}
            </button>
          </div>
        </div>
      </form>
